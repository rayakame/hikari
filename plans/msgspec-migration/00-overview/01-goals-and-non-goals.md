...
gone (G7, G9); and the existing test suite passes with the identity/copy assertions rewritten
([../10-testing/02-cache-copy-and-enum-tests.md](../10-testing/02-cache-copy-and-enum-tests.md)).
There is no pending app decision anywhere. The deferred non-goals (builders,
